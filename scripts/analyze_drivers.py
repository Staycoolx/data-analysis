...
def analyze_drivers(file_path, target_col, output_dir=None, task_type='auto'):
    ...
    print(f"Dropped constant/ID columns: {drop_cols}")
    ...
    with open(report_file, 'w') as f:
        ...
        for i, feature in enumerate(top_features):
            # Use original data for plotting to be readable
            ...
            # If classification task
                ...
                # If feature is numeric with many unique values, use boxplot/kde
                ...
                # If feature is categorical or few values, use barplot
                else:
...
if __name__ == "__main__":
    ...
    parser.add_argument("target_col", help="Target column to analyze (e.g., Attrition, Sales)")
